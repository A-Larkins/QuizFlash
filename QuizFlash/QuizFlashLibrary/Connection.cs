...
namespace QuizFlashLibrary
{
    public class DBConnect
    {
        ...
        // String SqlConnectString = "server=cis-mssql1.temple.edu;Database=FA20_3342_tuh34847;User id=tuh34847;Password=theiquieN9";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=FA20_3342_tuh34847;User id=tuh34847;Password=theiquieN9";
