...
<div class="card text-center">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><asp:Label ID="lblAnswer" runat="server" Font-Size="Large" Text="Answer Answer Answer"></asp:Label></p>
    <p class="card-text">
        ...
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
        <asp:Button ID="btnNext" runat="server" Font-Size="Medium" Text="Next" class="btn btn-primary" OnClick="btnNext_Click" />
    </p>
    <p class="card-text">
        <asp:Button ID="btnRelax" Width="40%" runat="server" Font-Size="Large" Text="Relax" class="btn btn-primary" OnClick="btnRelax_Click" />
    </p>
